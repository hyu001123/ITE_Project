...
static bool imagePlayerLoadPrev;
...
bool ImagePlayerOnTimer(ITUWidget* widget, char* param)
{
    ...
    {
        bool ret = ituIconLoadJpegData(imagePlayerViewIcon, imagePlayerData, imagePlayerDataSize);
        if (ret)
        {
